...
INSERT INTO "new_EmailDraft" ("batchId", "body", "contactId", "createdAt", "id", "ownerUserId", "scheduledAt", "status", "subject") SELECT "batchId", "body", "contactId", "createdAt", "id", "ownerUserId", "scheduledAt", "status", "subject" FROM "EmailDraft";
