 ...
 *
 * Android만 지원한다: iOS 광고(CBPeripheralManager 경유)는 react-native-ble-peripheral로
 * 시도했다가 podspec 부재로 Expo autolinking이 안 돼 되돌렸다. iOS 기기는 스캔(다른 사람 태깅)만
 * 가능하고, 두 기기가 서로 태깅하려면 최소 한쪽이 Android여야 한다.
 */
